							...
							<form id="form1" class="form-horizontal" role="form" action="#"
								...
								<!-- <div class = "from-group">
									...
									<div  class = "col-md-12" style="margin-top: 30px">
										<div class = "col-md-2" >
											<input type="text" class="form-control"  placeholder="人员编号" value="001">
										</div>
										<div class = "col-md-2" >
											<input type="text" class="form-control"  placeholder="姓名" value="张三">
										</div>
										<div class = "col-md-2" >
											<input type="text" class="form-control"  placeholder="电话" value="15000000000">
										</div>
										<div class = "col-md-2" >
											<input type="text" class="form-control"  placeholder="入职时间" value="2014-12-23">
										</div>
										<div class = "col-md-2" >
