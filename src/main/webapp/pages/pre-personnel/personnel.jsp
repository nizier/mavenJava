...
<!--     航空器空中遇险应急处置预案 -->
   <div  class="col-md-9"  id="content_1" style="width:82%; " >
...
<form class="form-inline" style="margin:10px 0px 10px 10px;" name="" method="post">	
	  <form class="form-inline">
            <div class="form-group" style="line-height: 50px;margin-top:-8px">
                人员名称：<input type="text" class="form-control" id="projectName" placeholder="请输入人员名称">
            </div>
            ...
            查询</button>
            <button type="button" id="resetBtn" onclick="addEvent()" class="sbtn sbtn-blue" style="margin-right: 15px;margin-top:5px;float:right;">
            删除
           	</button>
			<button type="button" id="updates" class="sbtn sbtn-blue" style="margin-right: 15px;margin-top:5px;float:right;">
            编辑
           	</button>
             <a href="<%=path %>/pages/pre-personnel/addPerson2.jsp"><button type="button" id="searchBtn" class="sbtn sbtn-blue" style="float: right ;margin-right: 15px;margin-top:4px ">
            新增</button></a>
...
<script type="text/javascript" src="<%=path %>/businessJs/personal.js"></script>
<script type="text/javascript">
$(document).ready(function() {
	
	var datas = [
{  "ids":"1","id":"001" , "name":"张三","time":"15000000000","status":"2018/11/11","level":"安检","ooo":"暂无"},
{  "ids":"2","id":"002" , "name":"李四","time":"15000000000","status":"2018/11/11","level":"护卫","ooo":"暂无"},
							...
							{id:'ids', title:'序号', type:'number', columnClass:'text-center'},
	                     	...
	                     	{id:'name', title:'姓名', type:'string', columnClass:'text-center',
	                     		resolution:function(value, record, column, grid, dataNo, columnNo){ 	                     			
	                		        var content = ''; 	                     			                     			
	                		        content += '<a href="<%=path %>/pages/pre-personnel/look_person.jsp">'+value+'</a>'; 
	                		        return content;                     			
	                		    }},
	                     	{id:'time', title:'电话', type:'string', columnClass:'text-center'},
	                     	{id:'status', title:'入队时间', type:'string', columnClass:'text-center'},
	                     	{id:'level', title:'部门', type:'string', columnClass:'text-center'}
	                     	/* {id:'ooo', title:'照片', type:'string', columnClass:'text-center',
	                     		resolution:function(value, record, column, grid, dataNo, columnNo){ 	                     			
	                		        var content = ''; 	                     			                     			
 	                     ...
 	                     var grid_2_1_1 = $.fn.dlshouwen.grid.init(gridOption_2_1_1);
  	                     ...
  	                     $("#resetBtn").click(function(){
  	                    	...
  	                    	$("#updates").click(function(){
  	                    		...
  	                    		window.location.href = "<%=path %>/pages/pre-personnel/updatePerson2.jsp";
  	                    		 <%-- if (recordCounts != 1) {
  	                    			 showMsg('请选择一条数据操作！',3);
  	                    		 } else {
  	                    			window.location.href = "<%=path %>/pages/pre-personnel/updatePerson2.jsp";
