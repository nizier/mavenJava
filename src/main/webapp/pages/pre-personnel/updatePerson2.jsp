...
<body>
	...
	var datas = [
		...
		{  "ids":"2","id":"004" , "name":"马六","phone":"15000000000","status":"2018/11/11","level":"护卫","ooo":"暂无"},
		{  "ids":"3","id":"005" , "name":"宋七","phone":"15000000000","status":"2018/11/11","level":"安检","ooo":"暂无"},
		{  "ids":"4","id":"006" , "name":"晁八","phone":"15000000000","status":"2018/11/11","level":"护卫","ooo":"暂无"}
	];
	var gridColumns_2_1_1 = [
							{id:'ids', title:'序号', type:'number', columnClass:'text-center'},
	                     	...
	                     	{id:'status', title:'操作', type:'string', columnClass:'text-center', 
	                     		resolution:function(value, record, column, grid, dataNo, columnNo){ 	                     			
	            		        var content = ''; 	                     			
	            		        content += '<button class="sbtn sbtn-blue" id="addPerson"  onclick=addPerson("'
 ...
 */
	var shujv = [
		{  "ids":"1","id":"002" , "name":"李四","phone":"15000000000","status":"2018/11/11","level":"护卫","ooo":"暂无"},
		{  "ids":"2","id":"003" , "name":"周五","phone":"15000000000","status":"2018/11/11","level":"安检","ooo":"暂无"}
	];
	var params = [];
	...
	var rescueGridColumns = [
							{id:'ids', title:'序号', type:'number', columnClass:'text-center'},
	                     	...
	                     	{id:'status', title:'操作', type:'string', columnClass:'text-center', 
	                     		resolution:function(value, record, column, grid, dataNo, columnNo){ 	                     			
	            		        var content = ''; 	                     			
	            		        content += '<button class="sbtn sbtn-blue" id="addPerson"  onclick=cancelPerson("'
