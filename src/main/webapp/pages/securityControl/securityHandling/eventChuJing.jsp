				...
				<div class="modal-body" id="stateBody">
					<div id="sys-step1" class="floatright"style="clear:both;">
						<ul>
							...
							<li class="step2"><i>2</i><p>任务处理中</p><div class="auto_border"></div></li>
			...
			<div class="modal-content">
				...
				<div class="modal-body" id="stateBody">
					<div id="sys-step1" class="floatright"style="clear:both;">
						<ul>
							<li class="step1 active"><i>1</i><p>已报警</p><p>2017年7月12日 14:00:37</p><p>报警人:张三</p><div class="auto_border"></div></li>
							<li class="step2 active"><i>2</i><p>任务处理中</p><p>2017年7月12日 14:10:37</p><p>处理人:张三</p><div class="auto_border"></div></li>
							<li class="step4"><i>3</i><p>处理完成</p><div class="auto_border"></div></li>
						</ul>
					</div>
					<div style="clear:both;"></div>
				...
				<div class="modal-body" id="stateBody">
					<div id="sys-step1" class="floatright"style="clear:both;">
						<ul>
							<li class="step1 active"><i>1</i><p>已报警</p><p>2017年7月12日 14:00:37</p><p>报警人:张三</p><div class="auto_border"></div></li>
							<li class="step2 active"><i>2</i><p>任务处理中</p><p>2017年7月12日 14:10:37</p><p>处理人:张三</p><div class="auto_border"></div></li>
							<li class="step4 active"><i>3</i><p>处理完成</p><p>2017年7月12日 15:10:27</p><p>处理人:张三</p><div class="auto_border"></div></li>
						</ul>
					</div>
					<div style="clear:both;"></div>
				</div>
...
var datas = [{"xuhao":1,"ningchen":"摄像头不能扭转","leibie":"消防安全类",
	...
	{"xuhao":3,"ningchen":"摄像头不能扭转","leibie":"消防安全类",
			...
			"baojinfangshi":"","caijifangshi":"自动采集","chulizhuangtai":"3","caozuo":"3","view details":"查看详情"},
...
var gridColumns_2_1_1 = [
	...
	{id:'chulizhuangtai', title:'处理状态', type:'string', columnClass:'text-center',	resolution : function(value, record, column, grid, dataNo,
		...
		var content = '';
	 	if(value==1){
			content += '<a href="javascript:void(0)" onclick="doState(1)">未处理</a>';
		}
	 	else if(value==2){
	 		content += '<a href="javascript:void(0)" onclick="doState(2)">处理中</a>';
	 	}
	 	else if(value==3){
	 		content += '<a href="javascript:void(0)" onclick="doState(3)">处理完成</a>';
	 	}
		 return content;
	}},
	{id:'caozuo', title:'操作', type:'string', columnClass:'text-center', resolution:function(value, record, column, grid, dataNo, columnNo){
		 var content = '';
		 if(value==1){
			content += '<button class="sbtn sbtn-blue" onclick="handleBtn();" >事件处理</button>&nbsp;&nbsp;';
			content += '<button class="sbtn sbtn-blue" onclick="handleDetails();"> 查看详情</button>';
		}else if(value==2){
			content += '<button class="sbtn sbtn-blue" onclick="disposeBtn();" >处理完成</button>&nbsp;&nbsp;';
			content += '<button class="sbtn sbtn-blue" onclick="handleDetails();"> 查看详情</button>';
		}
		else{
			content += '<button class="sbtn sbtn-blue" onclick="handleDetails();"> 查看详情</button>';
...
function handleDetails(){
	window.location.href="chuJingDetails.jsp";
}
