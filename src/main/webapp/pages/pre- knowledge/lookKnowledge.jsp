    ...
    <div class="row" style="margin-top: 20px;">
       ...
       <!-- <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="基础知识教材-救援员1" placeholder="资料名称" aria-describedby="sizing-addon2" disabled="true">
            </div>
        </div>
         <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="救援员基础人员入门教材" placeholder="简介" aria-describedby="sizing-addon2"disabled="true">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
				<textarea  id="trainingCt" class="form-control" style="width: 100%" placeholder="资料内容" disabled="true">救援人员基础教材</textarea>
			</div>
        </div>
    </div>
    <div class="row" style="margin-top: 20px;">
