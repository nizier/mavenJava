...
<!-- 											</div> -->
											<h3><a href="#" id="btn" style="font-weight:normal;line-height: 1.5;">安防系统</a></h3>
											<div id="example-0">
											...
											<h3><a href="#" style="font-weight:normal;line-height: 1.5;">安全资源</a></h3>
											<div id="example-0">
												<input class="showtable" type="checkbox"  id="firesdevice" >灭火器<br/>
...
<!-- 						 </div> -->
					...
					<span>设备数据统计表</span><a class="glyphicon glyphicon-remove remove-btn"
				id="remove-btn" onclick="removeWin($('#main_table'));"></a>
				
				
				</div>
						<div class="static_nav" style="padding-bottom:10%">
							<span class="indicator">设备名称：</span>
							<select class="form-control" style="width:28%;margin:1% 0 0 0;display:inline;float:left">
							   <option value=1>视频监控设备</option>
							   <option value=2>门禁设备</option>
							   <option value=3>围界设备</option>
							   <option value=4>消防栓设备</option>
							   <option value=4>手动报警设备</option>
							</select>
			...
			<ul class="pagination" style="position:relative;bottom:23px;left:70px;">
				...
				<li>
					...
					<!-- tdt -->
<!-- 					lzz数据表		 -->
<!-- 			<div class="main_table" id="main_table" style="display: '';width:400px;border-radius: 8px;"> -->
<!-- 				<div class="title-event"> -->
<!-- 					<span>设备数据表</span>				 -->
<!-- 				</div> -->
...
<!-- 			</div> -->
					...
					<div class="main_graphic" id="tjt" style="display: '';width:400px;height:370px;border-radius: 8px;">
					    <div class="title-event">
					<span>设备数据统计图</span><a class="glyphicon glyphicon-remove remove-btn"
