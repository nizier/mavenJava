						...
						<div class="portlet box blue-hoki">
							<div class="portlet-title">
								<div class="caption"  id="title">
									<i class="fa fa-th-list"></i>四级目录信息
								</div>
...
<!-- 								     <a href="subordinateDirectory.jsp" style="padding-left:5px;"><button class="sbtn sbtn-default">返回上级目录</button></a> -->
<!-- 								</div> -->
                                     <div  style="float: right;padding: 3px 0px;margin-left: 5px;">
				<a href="subordinateDirectory.jsp"><button type="button"  onclick="javascript:window.location.href='#'"
	...
	var gridColumns_2_1_1 = [
	                     	...
	                     	{id:'next', title:'下级目录', type:'string',  columnClass:'text-center'
	                     		, resolution:function(value, record, column, grid, dataNo, columnNo){ 	                     			
                  			        var content = ''; 	                     			
                  			      content +='<a onclick="next();"><button class="sbtn sbtn-default" id="next">进入下级目录</button></a>'; 	                     			                			  
                  			        return content;                     			
                  			    }			
