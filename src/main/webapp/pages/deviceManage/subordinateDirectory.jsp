						...
						<div class="portlet box blue-hoki">
							<div class="portlet-title">
								<div class="caption"  id="title">
									<i class="fa fa-th-list"></i>三级目录信息
								</div>
...
<!-- 								     <a href="secondDirectory.jsp" style="padding-left:5px;"><button class="sbtn sbtn-default">返回上级目录</button></a> -->
<!-- 								</div> -->
 <div  style="float: right;padding: 3px 0px;margin-left: 5px;">
				<a href="secondDirectory.jsp"><button type="button"  onclick="javascript:window.location.href='#'"
...
<!-- 编辑 -->
  ...
  <div class="form-group">
    <label for="lastname" class="col-sm-4 control-label">目录级别</label>
    <div class="col-sm-5">
      <input type="text" class="form-control" id="lastname" placeholder="三级">
    </div>
  </div>
</form>
                            </div>
...
$(document).ready(function() {
	...
	var datas = [
{ "id":"1" , "name":"视频监控系统","pre":"安防系统","level":"三级目录"},
{ "id":"2" , "name":"门禁系统","pre":"安防系统","level":"三级目录"},
{ "id":"3" , "name":"围界系统","pre":"安防系统","level":"三级目录"},
{ "id":"4" , "name":"道口系统","pre":"安防系统","level":"三级目录"},
];
	...
	var gridColumns_2_1_1 = [
	                     	...
	                     	{id:'next', title:'下级目录', type:'string',  columnClass:'text-center'
	                     		, resolution:function(value, record, column, grid, dataNo, columnNo){ 	                     			
                  			        var content = ''; 	                     			
                  			      content +='<a href="blankDirectory.jsp"><button class="sbtn sbtn-default" id="next">进入下级目录</button></a>'; 	                     			                			  
                  			        return content;                     			
                  			    }			
