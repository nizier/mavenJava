...
<form name="moduleForm" class="form-horizontal" id="moduleForm" action="<c:url value='/module/update' />" method="post">
    <div class="row" style="margin-top: 20px;">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="关于此资源的描述。。。" placeholder="设备/资源描述" aria-describedby="sizing-addon2" >
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">设备/资源编号<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="A000mu" placeholder="设备/资源编号" aria-describedby="sizing-addon2">
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">设备/资源名称<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="救护车" placeholder="设备/资源名称" aria-describedby="sizing-addon2">
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">设备/资源型号<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="大型救护车" placeholder="设备/资源型号" aria-describedby="sizing-addon2">
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">负责人<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="张三" placeholder="负责人" aria-describedby="sizing-addon2">
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">设备/资源数量<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="1" placeholder="设备/资源数量" aria-describedby="sizing-addon2">
            </div>
        </div>
         <div class="form-group">
         ...
         <div class="form-group">
			...
			<div class="col-sm-2">
				<input type="date" class="form-control" placeholder="起始时间" value="2018-07-09"/>
			</div>
		</div>
		<div class="form-group">
			<span class="col-sm-4 control-label">生产日期<span style="color:red">*</span></span>
			<div class="col-sm-2">
				<input type="date" class="form-control" placeholder="生产日期" value="2017-12-20" />
			</div>
		</div>
		<div class="form-group">
			<span class="col-sm-4 control-label">截止日期<span style="color:red">*</span></span>
			<div class="col-sm-2">
				<input type="date" class="form-control" placeholder="截止使用日期"  value="2025-12-20"/>
			</div>
		</div>
		<div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="救护车第五仓库" placeholder="仓库名称" aria-describedby="sizing-addon2">
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">存放地点<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="三号车间" placeholder="存放地点" aria-describedby="sizing-addon2">
            </div>
        </div>
         <div class="form-group">
            <span class="col-sm-4 control-label">维保时间<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="2018-10-22" placeholder="维保时间" aria-describedby="sizing-addon2">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="120000" placeholder="设备资源金额" aria-describedby="sizing-addon2">
            </div>
        </div>
         <div class="form-group">
