			...
			<div class="classify-content" style="display: block;">
				...
				<div id="wrapper-250">
					<div id="accordion-device" data-options="multiple:false;"
						style="height: 300px;">
						<h3>
							<a href="#" style="font-weight: small; line-height: 1.5;">区域</a>
						</h3>
						<div id="example-0">
							<input type="checkbox" value="gasxt" title="全部" id="camera"
								 onclick="showData(this,'all');" checked="checked">所有<br /> 
								<input type="checkbox" value="xfbjsb" title="航站区"
								id="fire-extinguisher" checked="checked">航站区<br /> 
								<input type="checkbox" value="mj" title="飞行区"
								onclick="clickCheckbox(this,0)" checked="checked">飞行区<br />
								<input type="checkbox" value="mj" title="控制区"
								onclick="clickCheckbox(this,0)" checked="checked">控制区<br />
								<input type="checkbox" value="mj" title="公共区"
								onclick="clickCheckbox(this,0)" checked="checked">公共区<br />

						</div>

						<h3>
							<a href="#" style="font-weight: normal; line-height: 1.5;">在线状态</a>
						</h3>
						<div id="example-0">
							<input type="checkbox" value="gawz" title="所有"
								onclick="showData(this,'all');">所有<br /> <input
								type="checkbox" value="gawz" title="在线"
								onclick="showData(this,'all');">在线<br /> <input
								type="checkbox" value="yjwz" title="离线"
								onclick="showData(this,'offline');">离线<br />
						</div>
						<h3>
							<a href="#" style="font-weight: normal; line-height: 1.5;">运行状况</a>
						</h3>
						<div id="example-0">
							<input type="checkbox" value="jy" title="所有" id="security-guard"
								onclick="showData(this,'all');">所有<br /> <input
								type="checkbox" value="jy" title="正常" id="security-guard">正常<br />
							<input type="checkbox" value="jc" title="故障"
								onclick="showData(this,'damage');">故障
						</div>
