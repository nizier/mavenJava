...
<div class="col-md-12" id="content_1"
	...
	<div class="left-tool" style="position: absolute; left: -50px">
		...
		<header class="clearfix">
			<div class="header-logo">航站楼区域人流量统计</div>
			...
			<div class="classify-content" style="display: block;">
				...
				<div id="wrapper-250">
					<div id="accordion-device" data-options="multiple:false;"
						style="height: 300px;">
						<h3>
							<a href="#" style="font-weight: small; line-height: 1.5;">出发大厅</a>
						</h3>
						<div id="example-0" style="display: block;">
							<span class="area-name">A区:</span><span class="area-data">135人</span><br />
							<span class="area-name">B区:</span><span class="area-data">245人</span><br />
							<span class="area-name">C区:</span><span class="area-data">142人</span><br />
							<span class="area-name">D区:</span><span class="area-data">353人</span><br />
						</div>

						<h3>
							<a href="#" style="font-weight: small; line-height: 1.5;">到达大厅</a>
						</h3>
						<div id="example-0" style="display: block;">
							<span class="area-name">A区:</span><span class="area-data">135人</span><br />
							<span class="area-name">B区:</span><span class="area-data">245人</span><br />
						...
						<h3>
							<a href="#" style="font-weight: normal; line-height: 1.5;">值机岛</a>
						</h3>
						<div id="example-0" style="display: block;">
							<span class="area-name">值机岛:</span><span class="area-data">135人</span><br />
						</div>


						<h3>
							<a href="#" style="font-weight: normal; line-height: 1.5;">安检口</a>
						</h3>
						<div id="example-0">
							<span class="area-name">1号安检口:</span><span class="area-data">135人</span><br />
							<span class="area-name">2号安检口:</span><span class="area-data">245人</span><br />
							<span class="area-name">3号安检口:</span><span class="area-data">142人</span><br />
							<span class="area-name">4号安检口:</span><span class="area-data">353人</span><br />

						</div>


						<h3>
							<a href="#" style="font-weight: normal; line-height: 1.5;">登机口</a>
						</h3>
						<div id="example-0">
							<span class="area-name">1号登机口:</span><span class="area-data">135人</span><br />
							<span class="area-name">2号登机口:</span><span class="area-data">245人</span><br />
							<span class="area-name">3号登机口:</span><span class="area-data">142人</span><br />
							<span class="area-name">4号登机口:</span><span class="area-data">353人</span><br />
						</div>
