...
<form name="moduleForm" class="form-horizontal" id="moduleForm" action="<c:url value='/module/update' />" method="post">
    <div class="row" style="margin-top: 20px;">
          <div class="form-group">
            <span class="col-sm-4 control-label">所属培训机构<span style="color:red">*</span></span>
            <div class="col-md-4">
        ...
        <div class="form-group">
            <span class="col-sm-4 control-label">培训课程编号<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="A001" placeholder="培训课程编号" aria-describedby="sizing-addon2">
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">培训课程名称<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="常识培训" placeholder="培训课程名称" aria-describedby="sizing-addon2">
            </div>
        </div>
          <!-- <div class="form-group">
            <span class="col-sm-4 control-label">培训类别<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="常识培训" placeholder="培训类别" aria-describedby="sizing-addon2">
            </div>
        </div> -->
         <div class="form-group">
            <span class="col-sm-4 control-label">培训类别<span style="color:red">*</span></span>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="32时" placeholder="学时" aria-describedby="sizing-addon2">
            </div>
        </div>
        <!-- <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
				<textarea  id="trainingCt" class="form-control" style="width: 100%" placeholder="培训内容">日常常识培训</textarea>
			</div>
        </div>
    </div>
    <div class="row" style="margin-top: 20px;">
