...
<form name="moduleForm" class="form-horizontal" id="moduleForm" action="<c:url value='/module/update' />" method="post">
    <div class="row" style="margin-top: 20px;">
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="" placeholder="培训计划编号" aria-describedby="sizing-addon2">
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">培训计划名称<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="" placeholder="培训计划名称" aria-describedby="sizing-addon2">
            </div>
        </div>
        <!--起止时间 -->
        <div class="form-group">
			...
			<div class="col-sm-2">
				<input type="date" class="form-control" placeholder="起始时间" style="width: 207px;"/>
			</div>
			<div class="col-sm-2">
				<input type="date" class="form-control" placeholder="结束时间" style="width: 207px;"/>
			</div>
			</div>
       <!--  <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="" placeholder="学时" aria-describedby="sizing-addon2">
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">培训地点<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="" placeholder="培训地点" aria-describedby="sizing-addon2">
            </div>
        </div>
       <!--  <div class="form-group">
        ...
        <div class="form-group">
							...
							<div class="col-md-4">
								<textarea  id="trainingCt" class="form-control" style="width: 100%" placeholder="培训内容"></textarea>
							</div>
       ...
       <!--  <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="" placeholder="培训人数" aria-describedby="sizing-addon2">
            </div>
        </div>
         <div class="form-group">
								...
								<table class="table table-bordered">
									...
									<tbody>
										<tr>
											...
											<td>
												<a href="<%=path %>/pages/pre-plancultivate/lookUpdateCultivate.jsp">常识培训</a>
											</td>
											<td>32学时</td>
											<td>北京</td>
										</tr>
										<tr>
											...
											<td>
												<a href="<%=path %>/pages/pre-plancultivate/lookUpdateCultivate.jsp">场务培训</a>
											</td>
											<td>32学时</td>
											<td>上海</td>
										</tr>
										<tr>
											...
											<td>
												<a href="<%=path %>/pages/pre-plancultivate/lookUpdateCultivate.jsp">礼仪培训</a>
											</td>
											<td>32学时</td>
											<td>广州</td>
										</tr>
										<tr>
											...
											<td>
												<a href="<%=path %>/pages/pre-plancultivate/lookUpdateCultivate.jsp">应急措施培训</a>
											</td>
											<td>32学时</td>
											<td>深圳</td>
										</tr>
										<tr>
											...
											<td>
												<a href="<%=path %>/pages/pre-plancultivate/lookUpdateCultivate.jsp">岗位业务培训</a>
											</td>
											<td>32学时</td>
											<td>长安</td>
										</tr>
