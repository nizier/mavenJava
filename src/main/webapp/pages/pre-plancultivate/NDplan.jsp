...
<form class="form-inline" style="margin:10px 0px 10px 10px;" name="" method="post">	
	  <form class="form-inline">
          ...
          <!--   <button type="button" id="searchBtn" class="sbtn sbtn-blue" style="float: right ;margin-right: 15px;margin-top:4px ">
            批量删除</button> -->
             <button class="sbtn sbtn-blue" type="button" id="backBtn" style="float: right ;margin-right: 15px;margin-top:3px ">
             返回</button>
...
$(document).ready(function() {
	...
	var datas = [
		...
		{ "id":"4" ,"ids":"01培训营","idso":"A001" , "state":"1","states":"3","name":"常识培训","time1":"2018/01/01","time2":"2018/05/01","time3":"2018/01/01","time4":"32时","place":"北京","number":"55","number1":"1","number2":"1"},
			...
			resolution : function(value, record,column, grid, dataNo, columnNo) {
				if(value == '0'){
					var content = '<span style="color: #FF0000;">'+'未培训'+'</span>';
	             	...
	             	var content = '<span style="color: blue;">'+'未进行'+'</span>';
	            }
	          	return content;
	     	}},
