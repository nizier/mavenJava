...
<form name="moduleForm" class="form-horizontal" id="moduleForm" action="<c:url value='/module/update' />" method="post">
    <div class="row" style="margin-top: 20px;">
        <div class="form-group">
            ...
            <div class="col-md-4" >
                <input type="text" class="form-control" id="" name="" value="A001" placeholder="培训计划编号" aria-describedby="sizing-addon2"disabled="true">
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">培训计划名称<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="常识培训" placeholder="培训计划名称" aria-describedby="sizing-addon2"disabled="true">
            </div>
        </div>
        <!--起止时间 -->
        <div class="form-group">
			...
			<div class="col-sm-2">
				<input type="date" class="form-control" placeholder="起始时间" style="width: 207px;" value="2017-01-01" disabled="true"/>
			</div>
			<div class="col-sm-2">
				<input type="date" class="form-control" placeholder="结束时间" style="width: 207px;"value="2017-03-01" disabled="true"/>
			</div>
			</div>
       <!--  <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="北京" placeholder="培训地点" aria-describedby="sizing-addon2" disabled="true">
            </div>
        </div>
       <!--  <div class="form-group">
        ...
        <div class="form-group">
							...
							<div class="col-md-4">
								<textarea  id="trainingCt" class="form-control" style="width: 100%" placeholder="培训内容" disabled="true">按时打算的撒</textarea>
							</div>
       ...
       <!--  <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="50" placeholder="培训人数" aria-describedby="sizing-addon2"disabled="true">
            </div>
        </div>
         <div class="form-group">
            <span class="col-sm-4 control-label">培训状态<span style="color:red">*</span></span>
            <div class="col-md-4" style="margin-top: 6px" >
				未进行<input class="radio2" type="radio" name="radio" checked="checked" disabled="true"/>  
				进行中<input class="radio2" type="radio" name="radio" disabled="true"/>  
				已完成<input class="radio2" type="radio" name="radio" disabled="true"/> 
				未培训<input class="radio2" type="radio" name="radio" value="radio"disabled="true"/>
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">培训分类<span style="color:red">*</span></span>
            <div class="col-md-4" style="margin-top: 6px">
           		基础<input class="radio2" type="radio" name="radio1" value="radio单选项1" checked="checked"disabled="true"/>
				初训<input class="radio2" type="radio" name="radio1" value="radio单选项1"disabled="true"/>  
				复训<input class="radio2" type="radio" name="radio1" value="radio单选项2"disabled="true"/>  
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">培训方式<span style="color:red">*</span></span>
            <div class="col-md-4" style="margin-top: 6px">
           		内训<input class="radio2" type="radio" name="radio2" value="radio单选项1"checked="checked"disabled="true"/>
				外训<input class="radio2" type="radio" name="radio2" value="radio单选项1"disabled="true"/>  
				外请专家<input class="radio2" type="radio" name="radio2" value="radio单选项2"disabled="true"/>  
            </div>
        </div>
        <div class="form-group">
							...
							<div class="col-md-4">
								<input id="enclosure" class="form-control" type="text" placeholder="签到表" disabled="true">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="enclosure" class="form-control" type="text" placeholder="课件"disabled="true">
							</div>
							<!-- <input id="lefile" type="file" > -->
							<!-- <div class="col-md-4">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="enclosure" class="form-control" type="text" placeholder="照片"disabled="true">
							</div>
							<!-- <input id="lefile" type="file" > -->
							<!-- <div class="col-md-4">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input id="enclosure" class="form-control" type="text" placeholder="培训小结"disabled="true">
							</div>
							<!-- <input id="lefile" type="file" > -->
							<!-- <div class="col-md-4">
    ...
    <div class="row" style="margin-top: 20px;">
        <div class="col-md-11" style="text-align:center;">
            ...
            <button class="sbtn sbtn-default" type="button" id="backBtn" style="text-align: center;"><i class='fa fa-reply'></i>&nbsp;返回</button>
        </div>
    </div>
