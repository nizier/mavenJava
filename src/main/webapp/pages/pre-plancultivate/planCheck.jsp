...
<form class="form-inline" style="margin:10px 0px 10px 10px;" name="" method="post">	
	  <form class="form-inline">
            <div class="form-group" style="line-height: 50px;margin-top:-8px">
             ...
             <div class="form-group" style="line-height: 50px;margin-top:-8px">
               培训分类：<input type="text" class="form-control" id="projectName" placeholder="请输入培训分类">
            </div>
             <div class="form-group" style="line-height: 50px;margin-top:-8px">
                培训方式：<input type="text" class="form-control" id="projectName" placeholder="请输入培训方式">
            </div>
...
$(document).ready(function() {
	...
	var datas = [
		{ "id":"1" ,"ids":"01培训营","idso":"A001" , "state":"1","states":"1","name":"常识培训","time1":"2018/01/01","time2":"2018/05/01","time3":"2018/01/01","time4":"32时","place":"北京","number":"55","number1":"0","number2":"0"},
		{ "id":"2" ,"ids":"01培训营", "idso":"A002" ,"state":"0","states":"0","name":"常识培训","time1":"2018/01/01","time2":"2018/05/01","time3":"2018/01/01","time4":"32时","place":"上海","number":"40","number1":"1","number2":"1"},
		{ "id":"3" ,"ids":"01培训营","idso":"A001" , "state":"1","states":"2","name":"常识培训","time1":"2018/01/01","time2":"2018/05/01","time3":"2018/01/01","time4":"32时","place":"北京","number":"55","number1":"2","number2":"2"},
		{ "id":"4" ,"ids":"01培训营","idso":"A001" , "state":"1","states":"0","name":"常识培训","time1":"2018/01/01","time2":"2018/05/01","time3":"2018/01/01","time4":"32时","place":"北京","number":"55","number1":"1","number2":"1"},
	...
	var gridColumns_2_1_1 = [
		{id:'id', title:'序号', type:'number', columnClass:'text-center'},
     	...
     	{id:'states', title:'培训状态', type:'string', columnClass:'text-center',
			resolution : function(value, record,column, grid, dataNo, columnNo) {
				if(value == '0'){
					var content = '<span style="color: #FF0000;">'+'未进行'+'</span>';
				}else if(value == '1'){
	     	...
	     	{id:'number1', title:'培训分类', type:'string', columnClass:'text-center',
				resolution : function(value, record,column, grid, dataNo, columnNo) {
					if(value == '0'){
						var content = '<span style="color: #2D9900;">'+'基础'+'</span>';
					}else if(value == '1'){
		   				var content = '<span style="color: #1E90FF;">'+'初训'+'</span>';
		   			}
		   			else if(value == '2'){
		             	var content = '<span style="color: #FF0000;">'+'复训'+'</span>';
		            }
		          	return content;
		     	}},
	     	{id:'number2', title:'培训方式', type:'string', columnClass:'text-center',
					resolution : function(value, record,column, grid, dataNo, columnNo) {
						if(value == '0'){
							var content = '<span style="color: #2D9900;">'+'内训'+'</span>';
						}else if(value == '1'){
			   				var content = '<span style="color: #1E90FF;">'+'外训'+'</span>';
			   			}
			   			else if(value == '2'){
			             	var content = '<span style="color: #FF0000;">'+'外请专家'+'</span>';
			            }
			          	return content;
			     	}},
...
function unissueApp1(id){
  ...
  $(document).ready(function() {
		...
		var datas = [
			{ "id":"1" ,"ids":"A001" , "name":"常识培训","time1":"2018年1月","time2":"2018年1月","place":"北京","number":"55","number1":"40"},
			{ "id":"2" , "ids":"A002" ,"name":"场务培训","time1":"2018年1月","time2":"2018年1月","place":"上海","number":"40","number1":"40"},
			{ "id":"3" , "ids":"A003" ,"name":"礼仪培训","time1":"2018年1月","time2":"2018年1月","place":"广州","number":"20","number1":"10"},
			{ "id":"4" , "ids":"A004" ,"name":"应急措施培训","time1":"2018年1月","time2":"2018年1月","place":"深圳","number":"44","number1":"40"},
			{ "id":"5" , "ids":"A005" ,"name":"岗位业务培训","time1":"2018年1月","time2":"2018年1月","place":"长安","number":"5","number1":"4"},
			{ "id":"6" , "ids":"A006" , "name":"安全教育培训","time1":"2018年1月","time2":"2018年1月","place":"贵阳","number":"11","number1":"10"},
			{ "id":"7" , "ids":"A006" ,"name":"团队协作培训","time1":"2018年1月","time2":"2018年1月","place":"洛阳","number":"111","number1":"40"},
