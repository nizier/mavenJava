...
<form name="moduleForm" class="form-horizontal" id="moduleForm" action="<c:url value='/module/update' />" method="post">
    <div class="row" style="margin-top: 20px;">
        ...
        <div class="form-group">
            <span class="col-sm-4 control-label">事件编号<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="A004" placeholder="事件编号" aria-describedby="sizing-addon2" disabled="true">
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">事件名称<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="火警处理" placeholder="事件名称" aria-describedby="sizing-addon2" disabled="true">
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">事件内容<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="无" placeholder="事件名称" aria-describedby="sizing-addon2" disabled="true">
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">级别<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="中" placeholder="级别" aria-describedby="sizing-addon2" disabled="true">
            </div>
        </div>
         <div class="form-group">
            <span class="col-sm-4 control-label">事件处理状态<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="已办理" placeholder="事件处理状态" aria-describedby="sizing-addon2" disabled="true">
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">操作人<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="操作人A" placeholder="操作人" aria-describedby="sizing-addon2" disabled="true">
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">部门<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="消防部门" placeholder="部门" aria-describedby="sizing-addon2" disabled="true">
            </div>
        </div>
        <div class="form-group">
            <span class="col-sm-4 control-label">操作时间<span style="color:red">*</span></span>
            <div class="col-md-4">
                <input type="text" class="form-control" id="" name="" value="2018-01-22 11:47" placeholder="操作时间" aria-describedby="sizing-addon2" disabled="true">
            </div>
        </div>
        <div class="form-group">
			 <span class="col-sm-4 control-label">附件<span style="color:red">*</span></span>
					...
					<div class="col-md-4">
						<input id="enclosure" class="form-control" type="text" placeholder="附件" disabled="true">
					</div>
					<div class="col-md-4">
						<div class="sbtn sbtn-blue" onclick="$('input[id=lefile]').click();" >查看附件</div>
					</div>
			</div>
			<div class="form-group">
				<span class="col-sm-4 control-label">过程评估<span style="color:red">*</span></span>
					<div class="col-md-4">
						<textarea  id="trainingCt" class="form-control" style="width: 100%" placeholder="过程评估"></textarea>
					</div>
			</div>
			<div class="form-group">
				<span class="col-sm-4 control-label">建议总结<span style="color:red">*</span></span>
					<div class="col-md-4">
						<textarea  id="trainingCt" class="form-control" style="width: 100%" placeholder="建议总结"></textarea>
					</div>
			</div>
    </div>
    <div class="row" style="margin-top: 20px;">
