						...
						<div class="portlet-body form">
							<form id="form1" class="form-horizontal" role="form" action="#"
								...
								<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" class="form-control" value="A0001" readonly="readonly">
										</div>
									...
									<div class="form-group">
										<label class="col-md-4 control-label">方案名称<span
											class="required">* </span></label>
										<div class="col-md-6">
											<input type="text" class="form-control" value="消防应急演练方案" readonly="readonly">
										</div>
									...
									<div class="form-group">
										<label class="col-md-4 control-label">方案描述<span
											class="required">* </span></label>
										<div class="col-md-6">
											<textarea class="form-control" readonly="readonly">消防应急演练方案</textarea>
										</div>
									</div>
									 <div class="form-group" >
