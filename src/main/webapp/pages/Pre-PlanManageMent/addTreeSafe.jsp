							...
							<form id="form1" class="form-horizontal" role="form" action="#"
								...
								<div class="form-body">
									<div class="form-group">
										<label class="col-md-4 control-label">目录编号<span
											class="required">* </span></label>
										<div class="col-md-6">
											<input type="text" class="form-control" placeholder="请输入目录编号">
										</div>
										
									</div>
									<div class="form-group">
										<label class="col-md-4 control-label">目录名称<span
											class="required">* </span></label>
										<div class="col-md-6">
									...
									<div class="form-group">
										<label class="col-md-4 control-label">版本号<span
											class="required">* </span></label>
										<div class="col-md-6">
									...
									<div class="form-group">
										<label class="col-md-4 control-label">目录描述<span
											class="required">* </span></label>
										<div class="col-md-6">
