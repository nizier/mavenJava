							...
							<form id="form1" class="form-horizontal" role="form" action="#"
								...
								<div class="form-body">
									...
									<span class="required">* </span></label>
										<div class="col-md-6">
											<input type="text" class="form-control" placeholder="附件名称" value="航空器紧急事件">
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<textarea class="form-control" >这是一个上传的航空器紧急事件附件</textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-4 control-label">上传人<span
											class="required">* </span></label>
										<div class="col-md-6">
											<input type="text" class="form-control" value="张三" readonly="readonly">
										</div>
									...
									<div class="row">
										<div class="col-md-offset-5 col-md-9">
											...
											<button style="margin-left: 45px;" type="button"
												 onclick="window.location.href='planList.jsp'"
