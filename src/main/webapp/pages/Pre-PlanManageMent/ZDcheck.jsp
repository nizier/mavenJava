								...
								<div class="form-body">
									...
									<div class="form-group">
										<label class="col-md-4 control-label">检查单编号<span
											class="required">* </span></label>
										<div class="col-md-6">
											<input type="text" class="form-control" value="" placeholder="请输入检查单编号">
										</div>
									...
									<div class="form-group">
										<label class="col-md-4 control-label">检查单名称<span
											class="required">* </span></label>
										<div class="col-md-6">
											<input type="text" class="form-control" value="" placeholder="请输入检查单名称">
										</div>
									...
									<label class="col-md-4 control-label">检查单构建</label>
										...
										<button type="button" class="sbtn sbtn-default" style="" onclick="check()">选择模板</button>
										</div>
									</div>
									<!-- <div class="form-group">
