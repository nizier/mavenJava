...
<ul id="myTab" class="nav nav-tabs">
    <li class="active"><a href="humanResource.jsp">
            GIS展示</a>
    </li>
    <li class="active"><a href="HumanList.jsp"  data-toggle="tab">信息列表</a></li>
</ul>
						...
						<div class="portlet box blue-hoki">
							<div class="portlet-title">
								<div class="caption"  id="title">
									<i class="fa fa-th-list"></i>安保人员列表
								</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">添加安保人员信息</h4>
            </div>
                            ...
                            {id:'photo', title:'照片', type:'string', columnClass:'text-center'
	                     	...
	                     	{id:'part', title:'员工部门', type:'string', columnClass:'text-center'},
 	                     	{id:'caozuo', title:'操作', type:'string', columnClass:'text-center'
 	                     		, resolution:function(value, record, column, grid, dataNo, columnNo){ 	                     			
                  			        var content = ''; 	                     			
                  			        content += '<a href="#"><button class="sbtn sbtn-default" data-toggle="modal" data-target="#addHuman" >编辑</button></a>'; 	                     			
                  			        content += '  ';	                     			
