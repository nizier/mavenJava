...
<!-- 								</div> -->
								<div id="wrapper-250">
									<div id="accordion" data-options="multiple:false;" style="height:300px;">
											<h3><a href="#" style="font-weight:normal;line-height: 1.5;">控制区</a></h3>
											<div id="example-0">			
											<input class="showtable" type="checkbox"  id="camera" checked="checked">候机隔离区<br/>
												<input class="showtable" type="checkbox"  id="access" >行李分拣装卸区<br/>
												<input class="showtable" type="checkbox" >航空器活动区<br/>	
												<input class="showtable" type="checkbox" >维修区<br/>	
												<input class="showtable" type="checkbox" >货物存放区<br/>																
											</div>
											<h3><a href="#" id="btn" style="font-weight:normal;line-height: 1.5;">要害部位</a></h3>
											<div id="example-0">	
											  <input class="showtable" type="checkbox"  id="access" >塔台<br/>
												<input class="showtable" type="checkbox" >区域管制中心<br/>	
												<input class="showtable" type="checkbox" >导航设施<br/>	
												<input class="showtable" type="checkbox" >机场供油设施<br/>	
												<input class="showtable" type="checkbox" >机场备用电源<br/>																																											
											</div>
...
<!-- 						 </div> -->
					...
					<!-- tdt -->
					<div class="main_table" id="main_table" style="display: '';width:400px;height:300px;border-radius: 8px;">
