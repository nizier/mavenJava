                    ...
                    <form id="form1" class="form-horizontal" role="form" action="#" enctype="multipart/form-data"  method="post">
									<div class="form-body">
										<div class="form-group">
											<label class="col-md-3 control-label">交接班人员名字<span class="required">* </span></label>
											<div class="col-md-6">
												<input  type="text" class="form-control" placeholder="交接班人员名字">
											</div>
											
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">交接班类型<span class="required">* </span></label>
											<div class="col-md-6">
												<input  type="radio" name="r" value="交班" checked>交班
												<input  type="radio" name="r" value="接班">接班
											</div>
											
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">交接班时间<span class="required">* </span></label>
											<div class="col-md-6">
												<input  type="date" class="form-control" placeholder="交接班时间">
											</div>
										...
										<div class="row">
											<div class="col-md-offset-5 col-md-9">
												...
												<button style="margin-left:45px;" type="button" onclick="javascript:location.href='changeShifts.jsp'" class="sbtn sbtn-default sbtn30">返回</button>
											</div>
										</div>
									</div>
