...
<%@include file="/pages/dutyManage/sectorLeftMenu.jsp" %>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8" />
...
<body>
  ...
  <li class="active"><a href="securitySectorResourceManagement.jsp">GIS展示</a></li>
   <li class="active"><a href="resourceManagementList.jsp">信息列表展示</a></li>
	  ...
	  <div id="resourcemap" class="map fl"></div>
       <!--机场地理信息服务-->
...
<script type="text/javascript" src="<%=path %>/businessJs/resourceMap.js" ></script>
