							...
							<form id="form1" class="form-horizontal" role="form" action="#"
								...
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input type="text" class="form-control" readonly="readonly" value="机场公安-部门总体预案">
										</div>
									...
									<span class="required">* </span></label>
										<div class="col-md-6">
											<input type="text" class="form-control" placeholder="预案名称">
										</div>
									</div>
									<div class="form-group">
									...
									<label class="col-md-4 control-label">是否涉密
										...
										<div class="col-md-6">
											...
											<input type="radio" name="change"  >否 
