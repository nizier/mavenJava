...
$(document).ready(function() {	
	var datas = [
{ "id":"1" , "name":"部门总体预案","describe":"部门总体预案","entry":"管理员"},																			
{ "id":"2" , "name":"分项预案","describe":"分项预案","entry":"管理员"},
{ "id":"3" , "name":"专项预案","describe":"专项预案","entry":"管理员"},
{ "id":"4" , "name":"岗位预案","describe":"岗位预案","entry":"管理员"},
{ "id":"5" , "name":"保障方案","describe":"保障方案","entry":"管理员"},
...
//	            },
	...
	var gridColumns_2_1_1 = [
     	...
     	{id:'name', title:'组织名称', type:'string', columnClass:'text-center'},
     	{id:'describe', title:'组织描述', type:'string',style:'width:10px;', columnClass:'text-center'},
     	{id:'entry', title:'录入人', type:'string',  columnClass:'text-center'},	                     	
      	{id:'caozuo', title:'操作', type:'string', columnClass:'text-center'
      		, resolution:function(value, record, column, grid, dataNo, columnNo){ 	                     			
 			        var content = ''; 	                     			
 			        content += '<a href="newEdit.jsp"><button class="sbtn sbtn-default">编辑</button></a>'; 	                     			
 			        content += '  ';	                     			
