                    ...
                    <form id="form1" class="form-horizontal" role="form" action="#" enctype="multipart/form-data"  method="post">
						<div class="form-body">
							<div class="form-group">
								...
								<div class="col-md-3">
									<input  type="text" class="form-control" placeholder="演练名称">
								</div>
								<label class="col-md-2 control-label">演练地点</label>
								<div class="col-md-3">
									<input  type="text" class="form-control" placeholder="演练地点">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<input  type="text" class="form-control" placeholder="演练编号">
								</div>
								...
								<div class="col-md-3">
	                                <select class="form-control">
	                                     ...
	                                     <option class="form-control" value="4">综合演练</option>
	                                </select>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-3">
	                                <select class="form-control">
	                                     <option class="form-control" value="请选择">请选择</option>
	                                     <option class="form-control" value="1">桌面演练</option>
								...
								<div class="col-md-3">
									<select class="form-control">
	                                    ...
	                                    <option class="form-control" value="1">综合预案</option>
							...
							<div class="form-group">
								...
								<div class="col-md-1">
									 <select class="form-control">
                                                  ...
                                                  <option class="form-control" value="3">年</option>
                                             </select>
								</div>
								<div class="col-md-1">
									 <select class="form-control">
                                         <option class="form-control" value="请选择">请选择</option>
                                         <option class="form-control" value="1">1次</option>
								...
								<div class="col-md-3">
									<select class="form-control">
	                                  	<option class="form-control" value="0">请选择</option>
	                                    <option class="form-control" value="1">航空器紧急事件</option>
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<select  class="form-control">
							  			<option value="volvo">航空器失事应急处置预案</option>
