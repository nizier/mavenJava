                    ...
                    <form id="form1" class="form-horizontal" role="form" action="#" enctype="multipart/form-data"  method="post">
						<div class="form-body">
							<div class="form-group">
								...
								<div class="col-md-3">
									<input  type="text" class="form-control" placeholder="事件编号" id="eventName" onchange="synchronize(this)" value="A9788MS">
								</div>
								
								<label class="col-md-2 control-label">事件名称：</label>
								<div class="col-md-3">
									<input  type="text" class="form-control" placeholder="事件名称" id="eventName" onchange="synchronize(this)" value="失火紧急救援" >
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-3">
									<input  type="text" class="form-control" placeholder="事件名称" id="eventName" onchange="synchronize(this)" value="2017-08-22">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<input  type="text" class="form-control" placeholder="负责人" id="eventPerson" onchange="synchronize(this)" value="张三">
								</div>
								<label class="col-md-2 control-label">上报人：</label>
								<div class="col-md-3">
	                                <input type="text" class="form-control" placeholder="上报人" value="李四">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-1">
									<input id="longitude"  type="text" class="form-control" placeholder="经度" value="116.642553">
								</div>
								
								<div class="col-md-1">
	                                <input id="dimension" type="text" class="form-control" placeholder="纬度" value="40.074827">
								</div>
								<div class="col-md-1">
								...
								<div class="col-md-3">
	                                 <input type="text" class="form-control" placeholder="位置描述" id="eventLocation" onchange="synchronize(this)" value="栈桥">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-3">
	                                <select class="form-control" >
	                                     ...
	                                     <option class="form-control" value="3">航空器紧急事件</option>
	                                </select>
								</div>	
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-3">
	                                 <textarea class="form-control" rows="2" id="eventContext" onchange="synchronize(this)">本次事件的发生是因为。。。
								...
								<div class="col-md-3">
									<input type="text" id="filePath" class="form-control" placeholder="附件" value="失火救急附件">
