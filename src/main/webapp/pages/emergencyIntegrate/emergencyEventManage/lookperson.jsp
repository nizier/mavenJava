                    ...
                    <form id="form1" class="form-horizontal" role="form" action="#" enctype="multipart/form-data"  method="post">
						<div class="form-body">
							<div class="form-group">
								...
								<div class="col-md-3">
									<input  type="text" class="form-control" placeholder="联系人姓名" value="刘一军" readonly="readonly">
								</div>
								<label class="col-md-2 control-label">联系人编号：</label>
								<div class="col-md-3">
									<input  type="text" class="form-control" placeholder="联系人编号" value="A002" readonly="readonly">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<input  type="text" class="form-control" placeholder="职位" value="副部长"  readonly="readonly">
								</div>
								<label class="col-md-2 control-label">电子邮件：</label>
								<div class="col-md-3">
	                                <input type="text" class="form-control" placeholder="电子邮件" value="tgfc22@163.com"  readonly="readonly">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<input  type="text" class="form-control" placeholder="手机号码" value="17905738349"  readonly="readonly">
								</div>
								<label class="col-md-2 control-label">IP地址：</label>
								<div class="col-md-3">
	                                <input type="text" class="form-control" placeholder="IP地址" value="179.57.34.59"  readonly="readonly">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-3">
	                                 <input type="text" class="form-control" placeholder="住址" value="双河大街与顺兴路交叉口南150米"  readonly="readonly">
								</div>
								<label class="col-md-2 control-label">部门：</label>
								<div class="col-md-3">
	                               <input type="text" class="form-control" placeholder="部门" value="副部长"  readonly="readonly">
								</div>
							</div>
