...
<div class="sodb-page-home">
	...
	<!-- 地图显示设置 -->
	<!-- <div id="map" style="width:50%;height:50%; display: none; margin-left: 39%; margin-top: 50%;"></div> -->
                    ...
                    <form id="form1" class="form-horizontal" role="form" action="#" enctype="multipart/form-data"  method="post">
						<div class="form-body">
							<div class="form-group">
								...
								<div class="col-md-3">
									<input  type="text" class="form-control" placeholder="事件编号" id="eventName" onchange="synchronize(this)" >
								</div>
								
								<label class="col-md-2 control-label">事件名称：</label>
								<div class="col-md-3">
									<input  type="text" class="form-control" placeholder="事件名称" id="eventName" onchange="synchronize(this)" >
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-3 control-label">事件级别：</label>
								<div class="col-md-3">
									<select type="text" name="eventLevel" class="form-control">
										<option>请选择</option>
										<option>低</option>
										<option>中</option>
										<option>高</option>
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<input  type="text" class="form-control" placeholder="负责人" id="eventPerson" onchange="synchronize(this)">
								</div>
								<label class="col-md-2 control-label">上报人：</label>
								<div class="col-md-3">
	                                <input type="text" class="form-control" placeholder="上报人">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-1">
									<input id="longitude"  type="text" class="form-control" placeholder="经度">
								</div>
								
								<div class="col-md-1">
	                                <input id="dimension" type="text" class="form-control" placeholder="纬度">
								</div>
								<div class="col-md-1">
								...
								<div class="col-md-3">
	                                 <input type="text" class="form-control" placeholder="位置描述" id="eventLocation" onchange="synchronize(this)">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-3">
	                                <select class="form-control" >
	                                     ...
	                                     <option class="form-control" value="2">综合预案</option>
	                                     <option class="form-control" value="3">专项预案</option>
	                                     <option class="form-control" value="4">部门预案</option>
	                                </select>
								</div>
								...
								<div class="col-md-3">
	                                <select class="form-control" >
	                                     <option class="form-control" value="1">请选择</option>
	                                     <option class="form-control" value="2">航空器紧急事件</option>
	                                     <option class="form-control" value="3">非航空器紧急事件</option>
	                                </select>
								</div>	
							</div>
							<div class="form-group">
								...
								<div class="col-md-3">
	                                <select id="choice" class="form-control" >
	                                     <option class="form-control" value="1">请选择</option>
	                                     <option class="form-control" value="2">航空器火警应急处置预案</option>
	                                     <option class="form-control" value="3">失火紧急处理预案</option>
	                                     <option class="form-control" value="4">航空器失事应急处置预案</option>
	                                </select>
								</div>
								...
								<div class="col-md-3">
	                                <select id="choice" class="form-control" >
	                                     <option class="form-control" value="1">请选择</option>
	                                     <option class="form-control" value="2">起落架事件</option>
	                                     <option class="form-control" value="3">发动机事件</option>
	                                     <option class="form-control" value="4">起落架事件</option>
	                                </select>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-md-3">
	                                 <textarea class="form-control" rows="2" id="eventContext" onchange="synchronize(this)">
					...
					<div class="tab-pane active" id="panel-938456" style="margin-top: 30px;">
						<div class="form-body" >
									...
									<span class="required">* </span></label>
										<div class="col-md-6">
											<input type="text" class="form-control" placeholder="事件名称" id="eventName2">
										</div>
									</div>
									<div class="form-group">
									...
									<span class="required">* </span></label>
										<div class="col-md-6">
											<input type="text" class="form-control" placeholder="位置描述" id="eventLocation2">
										</div>
									</div>
									<div class="form-group">
									<label class="col-md-4 control-label">事件内容描述
									<span class="required">* </span></label>
										<div class="col-md-6">
											<input type="text" class="form-control" placeholder="事件内容" id="eventContext2">
										</div>
									</div>
									<div class="form-group">
									...
									<span class="required">* </span></label>
										<div class="col-md-6">
											<input type="text" class="form-control" placeholder="事件负责人" id="eventPerson2">
										</div>
									</div>
										 <div class="form-group" >
