...
<body>
	<div class="sodb-page-home">
		<ul class="sodb-page-ul">
			...
			<li><a href="#">应急救援指挥协调</a> <i class="fa fa-angle-right"></i></li>
			<li><a href="#">新增通讯人员信息</a></li>
		</ul>
	</div>
				...
				<div id="content_1">
					<div class="portlet box blue-hoki">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-th-list"></i>新增通讯人员
							</div>
						</div>
	...
	<div  class="col-md-9" style="margin-left: 19%; width: 80%;">
		<div class="portlet box blue-hoki">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-th-list"></i>添加通讯录人员表								
				</div>
			</div>
