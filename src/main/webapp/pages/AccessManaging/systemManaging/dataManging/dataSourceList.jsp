	...
	<div style="width: 100%; padding: 0px 10px;">
		<form class="form-inline" style="margin: 10px 0px 10px 0px;" name=""
			...
			<div class="form-group">
				<span>数据源名称：</span> <input type="text" class="form-control"
		...
		<div class="divcss5">
			...
			<div class="divcss5_left">数据源管理</div>
		

			<div class="divcss5_right2">
				<button type="button" onclick="javascript:window.location.href='addDataSource'"
...
<script type="text/javascript">
	var datas = [ {
		"serialId" : 1,
		"datasource" : "T1进出刷卡事件信息",
		"system" : "T1门禁系统",
		"database" : "entrance_t1",
		"databaseType" : "ORCL",
		"createTime" : "2017-06-09 15:53"
	}, {
		"serialId" : 2,
		"datasource" : "T2进出刷卡事件信息",
		"system" : "T2门禁系统",
		"database" : "entrance_t1",
		"databaseType" : "ORCL",
		"createTime" : "2017-06-09 15:53"
	...
	var gridColumns = [
			...
			
			{
				...
				resolution : function(value, record, column, grid, dataNo,
						columnNo) {
					var content = '';
					content += '<button class="sbtn sbtn-blue" onclick="showDetails();" style="margin-left:10px"> 修改</button>';
