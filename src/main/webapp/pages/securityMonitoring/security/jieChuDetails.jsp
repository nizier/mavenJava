...
<body>
	<form class="form-inline">
		...
		<div class="row">
			<div class="col-md-1"></div>
			<div class="col-md-2 col-md-text-right">安全事件完成意见：</div>
		...
		<div class="row">
			...
			<div class="col-md-3"
				style="text-align: left; border: 1px solid #ccc; border-radius: 3px;">孙成</div>
			<div class="col-md-2" style="text-align: right;">解除时间：</div>
			<div class="col-md-3"
				style="text-align: left; border: 1px solid #ccc; border-radius: 3px;">2017-07-13 17:25:44</div>
			<div class="col-md-1" style="text-align: right;"></div>
		</div>
		<div class="row">
			<div class="col-md-1"></div>
			<div class="col-md-2 col-md-text-right">解除警报意见：</div>
			<div class="col-md-6" style="height: 100px; overflow-y: auto;border: 1px solid #ccc;border-radius: 3px;">事件已处理完，可解除警报，以后加强防范。</div>
			<div class="col-md-3"></div>
		</div>
