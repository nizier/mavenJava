...
<div class="divcss5"> 
    <div class="divcss5_left">安全事件处理</div>
	...
	<ul class="nav nav-tabs" id="securityTable" style="margin-top: 10px">
			...
			<li style="padding-top: 10px;padding-left: 250px">待处理事件：<font style="color: red;font-weight: bolder;">13</font>(件)&nbsp;&nbsp;已处理事件：30(件)</li>
	</ul>
...
var daichulidatas = [{"xuhao":1,"ningchen":"摄像头不能遥控","leibie":"安防安全类",
	"shijian":"2017-01-10 05:22:21","weizhi":"控制区",
	"fuzeren":"张三丰","bumen":"消防","fenpeiren":"李杜","baojinrenleibie":"机场值班人员",
	...
	{"xuhao":2,"ningchen":"摄像头不能遥控","leibie":"安防安全类",
		...
		"fuzeren":"李四","bumen":"消防","fenpeiren":"李杜","baojinrenleibie":"机场值班人员",
		"baojinfangshi":"电话","caijifangshi":"人工上报","chulizhuangtai":"1","caozuo":"1","view details":"查看详情"},
	{"xuhao":3,"ningchen":"摄像头不能遥控","leibie":"安防安全类",
			"shijian":"2017-01-10 05:22:21","weizhi":"控制区",
			"fuzeren":"李飞","bumen":"消防","fenpeiren":"李杜","baojinrenleibie":"机场值班人员",
	...
	{"xuhao":4,"ningchen":"摄像头不能遥控","leibie":"安防安全类",
				...
				"fuzeren":"张龙","bumen":"消防","fenpeiren":"李杜","baojinrenleibie":"机场值班人员",
				"baojinfangshi":" ","caijifangshi":"自动采集","chulizhuangtai":"1","caozuo":"1","view details":"查看详情"},
	{"xuhao":5,"ningchen":"摄像头不能遥控","leibie":"安防安全类",
					"shijian":"2017-01-10 05:22:21","weizhi":"控制区",
					"fuzeren":"司继娟","bumen":"消防","fenpeiren":"李杜","baojinrenleibie":"机场值班人员",
					"baojinfangshi":"电话","caijifangshi":"人工上报","chulizhuangtai":"1","caozuo":"1","view details":"查看详情"},
...
var chulidatas = [{"xuhao":1,"ningchen":"摄像头不能遥控","leibie":"安防安全类",
	"shijian":"2017-01-10 05:22:21","weizhi":"控制区",
	"fuzeren":"张三丰","bumen":"消防","fenpeiren":"李杜","baojinrenleibie":"机场值班人员",
...
var daichuliColumns = [
	...
	{id:'fenpeiren', title:'分配人', type:'string', columnClass:'text-center'},
	...
	{id:'chulizhuangtai', title:'处理状态', type:'string', columnClass:'text-center',	resolution : function(value, record, column, grid, dataNo,
			columnNo) {
		var content = '';
			content += '<a href="javascript:void(0)" onclick="doState(1)">处理中</a>';
		 return content;
	}},
	{id:'caozuo', title:'操作', type:'string', columnClass:'text-center', resolution:function(value, record, column, grid, dataNo, columnNo){
		 var content = '';
			content += '<button class="sbtn sbtn-blue" onclick="disposeBtn();" >填写处理意见</button>&nbsp;&nbsp;';
...
var chuliColumns = [
	...
	{id:'chulizhuangtai', title:'处理状态', type:'string', columnClass:'text-center',	resolution : function(value, record, column, grid, dataNo,
			columnNo) {
		var content = '';
	 		content += '<a href="javascript:void(0)" onclick="doState(2)">已处理</a>';
		 return content;
	}},
	{id:'caozuo', title:'操作', type:'string', columnClass:'text-center', resolution:function(value, record, column, grid, dataNo, columnNo){
		 var content = '';
...
var daichuli = $.fn.dlshouwen.grid.init(daichuliOption);
var chuli = $.fn.dlshouwen.grid.init(chuliOption);
...
function handleDetails(){
	window.location.href="chuLiDetails.jsp";
}
