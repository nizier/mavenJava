...
<div class="divcss5"> 
    ...
    <div class="divcss5_right">
    	<button type="button" onclick="javascript:window.location.href='eventEntry.jsp'" class="btn btn-default">安全事件录入</button>
    </div> 
    <div class="clear"></div>
</div> 
...
var datas = [{"xuhao":1,"biaohao":"100001","ningchen":"摄像头不能扭转","leibie":"消防安全类",
	"jibie":"一级","shijian":"2017-01-10 05:22:21","weizhi":"控制区",
	"baojinren":"张三丰","baojinrennumber":"18895731508","baojinrenleibie":"机场值班人员",
	"baojinfangshi":"电话","caijifangshi":"人工上报","chulizhuangtai":"未处理","caozuo":"事件确认","view details":"查看详情"},
	{"xuhao":2,"biaohao":"100002","ningchen":"摄像头不能扭转","leibie":"消防安全类",
		"jibie":"一级","shijian":"2017-01-10 05:22:21","weizhi":"飞行区",
		"baojinren":"李四","baojinrennumber":"18895731808","baojinrenleibie":"机场值班人员",
		"baojinfangshi":"电话","caijifangshi":"人工上报","chulizhuangtai":"未处理","caozuo":"事件确认","view details":"查看详情"},
	{"xuhao":3,"biaohao":"100003","ningchen":"摄像头不能扭转","leibie":"消防安全类",
			"jibie":"一级","shijian":"2017-01-10 05:22:21","weizhi":"控制区",
			"baojinren":"","baojinrennumber":"","baojinrenleibie":"机场值班人员",
			"baojinfangshi":"","caijifangshi":"自动采集","chulizhuangtai":"未处理","caozuo":"事件确认","view details":"查看详情"},
	{"xuhao":4,"biaohao":"100004","ningchen":"摄像头不能扭转","leibie":"消防安全类",
				"jibie":"二级","shijian":"2017-01-20 05:22:21","weizhi":"控制区",
				"baojinren":"","baojinrennumber":"","baojinrenleibie":"机场值班人员",
				"baojinfangshi":"","caijifangshi":"自动采集","chulizhuangtai":"未处理","caozuo":"事件确认","view details":"查看详情"},
	{"xuhao":5,"biaohao":"100005","ningchen":"摄像头不能扭转","leibie":"消防安全类",
					"jibie":"一级","shijian":"2017-01-10 05:22:21","weizhi":"控制区",
					"baojinren":"司继娟","baojinrennumber":"18895731518","baojinrenleibie":"机场值班人员",
					"baojinfangshi":"电话","caijifangshi":"人工上报","chulizhuangtai":"未处理","caozuo":"事件确认","view details":"查看详情"},
	{"xuhao":6,"biaohao":"100006","ningchen":"摄像头不能扭转","leibie":"消防安全类",
						"jibie":"一级","shijian":"2017-02-10 05:22:21","weizhi":"控制区",
						"baojinren":"","baojinrennumber":"","baojinrenleibie":"机场值班人员",
...
var gridColumns_2_1_1 = [
	...
	{id:'biaohao', title:'事件编号', type:'string', columnClass:'text-center'},
	{id:'ningchen', title:'事件名称', type:'string',  columnClass:'text-center'},
	{id:'leibie', title:'事件类别', type:'string', columnClass:'text-center'},
	{id:'jibie', title:'级别', type:'string', columnClass:'text-center'},
	{id:'shijian', title:'时间', type:'string', columnClass:'text-center'},
	{id:'weizhi', title:'位置', type:'string',  columnClass:'text-center'},
	{id:'baojinren', title:'报警人', type:'string', columnClass:'text-center'},
	{id:'baojinrennumber', title:'报警人联系方式', type:'string', columnClass:'text-center'},
	...
	{id:'operation', title:'操作', type:'string', columnClass:'text-center', resolution:function(value, record, column, grid, dataNo, columnNo){
		 var content = '';
		 content += '<button class="btn btn-xs btn-default" onclick="handleBtn();">事件确认</button>&nbsp;&nbsp;';		  
...
function handleBtn(){
	window.location.href="eventConfirmation.jsp";
}
