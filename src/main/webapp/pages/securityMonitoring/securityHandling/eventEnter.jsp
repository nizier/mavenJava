...
<div class="safesure" style="margin:0px 0px 10px 5px" >		
	...
	<div class="row row1">
		...
		<div class="col-md-4">
			<div class="row">
				<div class="col-md-4 col-md-text-right">时间：</div>
				<div class="col-md-8"><input type="text" class="form-control" placeholder="时间"/></div>
			</div>
		</div>
	</div>
	<div class="row row1">	
		...
		<div class="col-md-4">
			<div class="row">
				<div class="col-md-4 col-md-text-right">负责人：</div>
				<div class="col-md-8"><input type="text" class="form-control" placeholder="负责人"/></div>
			</div>
		</div>
		<div class="col-md-4">
			<div class="row">
				<div class="col-md-4 col-md-text-right">所在部门：</div>
				<div class="col-md-8">
					<select class="form-control">
						<option value="">请选择</option>
						<option>消防部</option>
	...
	<div class="row row1">
		...
		<div class="col-md-4">
			<div class="row">
				<div class="col-md-4 col-md-text-right">负责人处理意见：</div>
				<div class="col-md-8"><textarea name="a" style="width:180px;height:100px;"></textarea></div>
			</div>
		</div>									
	</div>
...
<div class="safeanniu" style="text-align:center">
	<a class="btn btn-primary" href="eventChuJing.jsp">提交</a>	
	<a class="btn btn-default" href="eventChuJing.jsp">返回</a>		
</div>				
</form>
</body>
</html>